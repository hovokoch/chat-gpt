...
export const Payment = ({ price }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const billingInputs = {
      name: e.target["first-name"].value,
  ...
  return (
    <form
      ...
      className="space-y-8 divide-y divide-gray-200 max-w-[600px] my-0 mx-auto border p-8 rounded-xl"
    >
      ...
      <div className="pt-5">
        <div className="flex justify-end">
          ...
          >
            {isProcessing
              ? "Processing..."
              : "Pay and continue with subscription"}
          </button>
        </div>
      </div>
    </form>
